<div>
    ...
    <div class="mt-2">
        <input id="custome Search" type="text" class="p-4 w-full border rounded-md bg-cool-gray-200 text-black"
            wire:model.live.debounce="searchText" placeholder="Vlucht nummer zoeken..." value="{{ $searchText }}">
    </div>
    <div class="{{ count($results) > 0 ? 'block' : 'hidden' }}">
        ...
        <input type="hidden" id="TripId" name="TripId" value="{{ $selectedId }}">
    </div>
</div>
