<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="Infix" class="block mt-1 w-full" type="text" name="Infix" :value="old('Infix')" autofocus
                autocomplete="name" />
        ...
        <div>
            ...
            <x-text-input id="BirthDate" class="block mt-1 w-full" type="date" name="BirthDate"
                :value="old('BirthDate')" required autofocus autocomplete="date" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="PasswordRepeat" class="block mt-1 w-full" type="password" name="PasswordRepeat" required
                autocomplete="new-password" />
