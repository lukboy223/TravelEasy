...
<div class="overflow-x-auto">
    <table class="w-3/4 bg-white dark:bg-gray-800 m-auto mt-5 mb-5">
        <thead>
            ...
            <th class="px-4 py-2 border border-gray-300">verzending status</th>
            ...
            @foreach($messages as $message)
                <tr>
                    ...
                    <td class="px-4 py-2 border border-gray-300">
                        <form action="{{ route('message.send', $message->MessageID) }}" method="POST">
                            @csrf
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">verzenden</button>
                        </form>
                    </td>
                    <td class="px-4 py-2 border border-gray-300">
